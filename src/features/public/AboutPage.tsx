  ...
  return (
    <section className="bg-[#26483E] px-6 py-16 text-[#FFFDF8] md:py-24">
      <div className="mx-auto max-w-7xl">
        ...
        <h1 className="mt-4 text-3xl font-bold leading-tight tracking-tight md:text-5xl md:leading-tight">
  ...
  return (
    <section className="bg-[#F4EFE7] px-6 py-16 md:py-20">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="mt-5 max-w-3xl text-base leading-relaxed text-[#5B6472]">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {FOUNDER_STATS.map((stat) => (
            <div
              key={stat.label}
              className="rounded-2xl border border-[#E8E1D8] bg-[#FFFDF8] p-6 text-center shadow-sm"
            >
              <p className="text-3xl font-bold text-[#26483E]">{stat.value}</p>
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-3">
          <div className="space-y-4 lg:col-span-1">
            <div className="rounded-2xl border border-[#E8E1D8] bg-[#FFFDF8] p-5 shadow-sm">
              <p className="text-xs font-semibold uppercase tracking-wider text-[#8A8F98]">Email</p>
              <p className="mt-1 text-sm font-medium text-[#172033]">hello@starproject.de</p>
            </div>
            <div className="rounded-2xl border border-[#E8E1D8] bg-[#FFFDF8] p-5 shadow-sm">
              <p className="text-xs font-semibold uppercase tracking-wider text-[#8A8F98]">Phone</p>
              <p className="mt-1 text-sm font-medium text-[#172033]">+49 561 000 0000</p>
            </div>
            <div className="rounded-2xl border border-[#E8E1D8] bg-[#FFFDF8] p-5 shadow-sm">
              <p className="text-xs font-semibold uppercase tracking-wider text-[#8A8F98]">Address</p>
              <p className="mt-1 text-sm font-medium text-[#172033]">
                Königsplatz 12, 34117 Kassel, Germany
              </p>
            </div>
            <div className="rounded-2xl border border-[#E8E1D8] bg-[#FFFDF8] p-5 shadow-sm">
              <p className="text-xs font-semibold uppercase tracking-wider text-[#8A8F98]">Legal</p>
              <div className="mt-1 flex flex-wrap gap-x-3 gap-y-1 text-sm font-medium text-[#26483E]">
                <a href="#" className="underline underline-offset-2 hover:text-[#547C6A]">
                  Impressum
                </a>
                <a href="#" className="underline underline-offset-2 hover:text-[#547C6A]">
                  Datenschutz
          ...
          <div className="rounded-2xl border border-[#E8E1D8] bg-[#FFFDF8] p-6 shadow-sm lg:col-span-1">
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <button
                type="submit"
                className="rounded-full bg-[#26483E] px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#1F3D35]"
              >
                Send Message
              </button>
            </form>
